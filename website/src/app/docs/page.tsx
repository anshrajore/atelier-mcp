...
export default function DocsPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#090d16] text-[#111827] dark:text-[#f1f5f9] transition-colors">
      <Navbar />

      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        {/* Header Breadcrumb */}
        <div className="flex items-center justify-between pb-6 border-b border-[#f1f5f9] dark:border-zinc-800 text-xs text-[#64748b] dark:text-zinc-400">
          <div className="flex items-center gap-2">
            <Link href="/" className="hover:text-[#111827] dark:hover:text-white flex items-center gap-1 font-medium">
              <ArrowLeft className="h-3.5 w-3.5" />
              <span>Back to Home</span>
            </Link>
            <span>/</span>
            <span className="text-[#111827] dark:text-white font-semibold">Documentation</span>
          </div>
          <div className="text-[11px] font-mono text-[#94a3b8] dark:text-zinc-500">
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Sidebar Nav (3 cols) */}
          <aside className="lg:col-span-3 sticky top-20 rounded-3xl bg-[#fafafa] dark:bg-zinc-900 border border-[#e2e8f0] dark:border-zinc-800 p-5 text-xs">
            <div className="text-[#111827] dark:text-white font-bold mb-3 pb-2 border-b border-[#e2e8f0] dark:border-zinc-800 flex items-center gap-2">
                ...
                <button
                  ...
                  className={`text-left px-3 py-2 rounded-xl transition-all ${
                    activeSection === item.id
                      ? "bg-white dark:bg-zinc-800 text-[#111827] dark:text-white font-semibold shadow-sm border border-[#e2e8f0] dark:border-zinc-700"
                      : "text-[#64748b] dark:text-zinc-400 hover:text-[#111827] dark:hover:text-white hover:bg-white/60 dark:hover:bg-zinc-800/60"
                  }`}
                >
                  {item.label}
                </button>
          ...
          <main className="lg:col-span-9 flex flex-col gap-12 text-xs">
            {/* 1. Overview */}
            <section id="overview" className="rounded-3xl bg-[#fafafa] dark:bg-zinc-900 border border-[#e2e8f0] dark:border-zinc-800 p-8">
              <div className="text-[11px] font-semibold text-[#ff7a00] uppercase tracking-wider mb-2">SECTION 01</div>
              <h1 className="font-serif text-2xl sm:text-3xl font-normal text-[#111827] dark:text-white">
                Overview & Design Principles
              </h1>
              <p className="mt-4 font-sans text-sm text-[#4b5563] dark:text-zinc-300 leading-relaxed">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-2xl bg-white dark:bg-zinc-950 border border-[#e2e8f0] dark:border-zinc-800 p-5 shadow-sm">
                  <div className="text-[#111827] dark:text-white font-bold text-sm">1. UI/UX Critic</div>
                  <p className="mt-1 text-[#64748b] dark:text-zinc-400 text-xs leading-relaxed">
                ...
                <div className="rounded-2xl bg-white dark:bg-zinc-950 border border-[#e2e8f0] dark:border-zinc-800 p-5 shadow-sm">
                  <div className="text-[#111827] dark:text-white font-bold text-sm">2. Backend Architecture Guard</div>
                  <p className="mt-1 text-[#64748b] dark:text-zinc-400 text-xs leading-relaxed">
